...
define Device/eap245-v1
  ...
  MTDPARTS := spi0.0:128k(u-boot)ro,64k(partition-table)ro,64k(product-info)ro,1792k(kernel),14080k(rootfs),192k(config)ro,64k(ART)ro,15872k@0x40000(firmware)
